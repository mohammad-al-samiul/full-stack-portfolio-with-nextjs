...
export default function Projects() {
  ...
  return (
    <div className="mt-8 lg:mt-20">
      ...
      <div className="w-full flex flex-col gap-20 justify-center items-center mt-8 lg:mt-20">
        {projects.map((project) => (
          <div
            key={project.id}
            className="relative bg-cover bg-no-repeat w-4/5 h-[500px] shadow-[0px_0px_40px_#1f1f1f] group"
            style={{
          ...
          >
            ...
            <div className="absolute text-white text-[100px] font-bold hidden group-hover:block right-[-10px] top-[-40px]">
              {project.id}
            </div>
            <div className="absolute flex flex-col gap-5 text-white bottom-[23%] left-[8%] z-20 transform group-hover:scale-110 transition-transform duration-400 lg:w-1/2">
